...
const Footer =() =>{
    ...
    return (
        <div className="relative bg-cover bg-center h-[400px] flex items-center justify-center text-white" style={{ backgroundImage: "url('https://grupo-hoteles.com/storage/app/2/page/1205002298-2-page-slider-1-habitacion-deluxe-centro-de-medellin-antioquia-colombia.webp')" }}>
        <div className="bg-black bg-opacity-50 w-full h-full absolute top-0 left-0"></div>
        
        <div className="relative z-10 flex flex-col md:flex-row md:justify-between items-center w-full px-10 md:px-20">
          <div className="md:w-[300px]">
            <h1 className="text-4xl font-bold">Hotel 47 Street</h1>
          ...
          <div className="absolute bottom-0 item-center right-5 w-40 h-[100px] md:w-60 md:h-60">
